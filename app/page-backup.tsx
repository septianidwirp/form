...
export default function Home() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div 
        className="hidden md:block fixed inset-0 w-full h-full z-10"
        style={{
            backgroundImage: 'url(/images/Desktop.png)',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            backgroundRepeat: 'no-repeat',
            minWidth: '1366px',  // ukuran umum 14 inch
            minHeight: '768px'
        }}
        />
      ...
      <div className="hidden md:grid md:grid-cols-2 min-h-screen max-h-screen overflow-hidden">
        {/* Left Side - Product Images */}
        <div className="relative flex items-center justify-center p-8">
          <div className="absolute z-10" style={{ left: '70px', top: '90px' }}>
            {/* Mall to Mall SVG */}
            <div className="mb-2">
              <img 
                src="/maltomal.svg" 
            ...
            <div style={{ 
              ...
              <p className="text-sm text-gray-700 leading-tight">at Senayan City LT</p>
              <p className="text-sm text-gray-700 leading-tight">GF Lobby East</p>
            </div>
         </div>
         </div>

        {/* Right Side - Registration Form */}
        <div className="flex flex-col items-center justify-center p-8 lg:p-12 overflow-y-auto max-h-screen">
          <div className="w-full max-w-md">
            ...
            <div className="bg-white/90 backdrop-blur-sm border-2 border-purple-200 rounded-2xl p-6 mb-8 shadow-sm">
            ...
            <div className="mt-6 text-center text-gray-500">
              ...
              <button className="w-full bg-white/90 backdrop-blur-sm border-2 border-gray-200 px-6 py-3 rounded-full font-medium hover:bg-gray-50 transition-all shadow-sm flex items-center justify-center">
      ...
      <div className="md:hidden min-h-screen flex flex-col">
        ...
        <div className="flex-1 bg-white/95 backdrop-blur-sm -mt-6 rounded-t-3xl p-6 pb-8">
          <RegistrationForm />
          ...
          <div className="mt-6 relative h-40">
            <div className="absolute bottom-0 left-0 w-16 h-20 bg-gray-200/80 backdrop-blur-sm rounded-2xl"></div>
            <div className="absolute bottom-0 left-20 w-20 h-28 bg-gray-300/80 backdrop-blur-sm rounded-2xl"></div>
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-14 h-28 bg-gray-400/80 backdrop-blur-sm rounded-full"></div>
            <div className="absolute bottom-0 right-0 w-24 h-40 bg-gray-400/80 backdrop-blur-sm rounded-2xl"></div>
          </div>
        </div>
      </div>
    </div>
